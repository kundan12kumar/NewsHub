...
const PayoutManagementAdminOnly = () => {
  ...
  const payoutData = useMemo(() => {
    ...
    return Object.entries(authorGroups)
      .map(([authorName, articles], index) => {
        ...
        const totalAmount = calculateAuthorTotal(
        ...
        const finalPaymentStatus =
          manualPaymentUpdates[authorId]?.status || paymentStatus;
        const finalLastPayment =
          manualPaymentUpdates[authorId]?.lastPayment || lastPaymentDate;
  ...
  const filteredPayoutData = payoutData.filter((author) => {
    ...
    const matchesStatus =
      paymentStatus === "all" || author.paymentStatus === paymentStatus;
    const matchesDateRange =
      !dateRange.start ||
      !dateRange.end ||
      (author.lastPayment >= dateRange.start &&
        author.lastPayment <= dateRange.end);
        ...
        <div className="pt-16 flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-text-secondary">
              Loading payout data from NewsAPI...
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="pt-16 flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-text-primary mb-2">
              Failed to load payout data from NewsAPI
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
            <div>
              ...
              <p className="text-text-secondary">
                Configure rates, calculate payments, and manage payouts for
                content creators
              </p>
            </div>
          ...
          <PayoutSummary
            ...
            pendingAuthors={
              filteredPayoutData.filter((a) => a.paymentStatus === "pending")
                .length
            }
          />
          ...
          {payoutData.length === 0 ? (
            <div className="bg-surface rounded-lg shadow-sm border border-border p-12 text-center">
              ...
              <p className="text-text-secondary">
                No valid authors found in the NewsAPI dataset. This could be
                because:
              </p>
              <ul className="text-text-secondary text-sm mt-2 space-y-1">
                <li>
                  • All articles have "Unknown Author" or missing author
                  information
                </li>
                <li>
                  • The NewsAPI data doesn't include author details for this
                  search
                </li>
